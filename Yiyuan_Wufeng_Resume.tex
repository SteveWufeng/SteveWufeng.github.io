...
\textbf{DevOps:}         & Docker, GitHub Actions (CI/CD), Railway, Cloudflare R2, Firebase, Google Cloud Platform, Azure DevOps \\
...
\textbf{Tools:}          & Git, OpenCode, Visual Studio Code, Vim, Android Studio, Figma, Proxmox, Virtual Machines, GitHub Copilot \\
\textbf{Hardware:}       & Raspberry Pi, ESP32, 3D Printing Design (OnShape), PixHawk, ArduPilot, Sixfab LTE \\
\end{tabular}
...
\begin{bullets}
  ...
  \item Trained OCRNet with NVIDIA TAO to detect defects and low-quality display outputs in industrial inspection workflows
  ...
  \item Leveraged GitHub Copilot to accelerate C++ inference pipeline development and automation scripts
\end{bullets}
\textit{Key Skills:} Python, C++, DirectML, NVIDIA TAO, Computer Vision, CI/CD, GitHub Copilot\par
...
\end{bullets}
\textit{Key Skills:} Flutter, Dart, Firebase, Firestore, RESTful APIs, SpringBoot, Android Studio, GitHub Copilot\par
...
\begin{bullets}
  ...
  \item Built RESTful API layer for captioning service and containerized the application with Docker for deployment
...
\end{bullets}
\textit{Key Skills:} Google Cloud Platform, Speech-to-Text, RESTful APIs, Docker, React, Vue.js, Python, GitHub Copilot\par
...
\project{Full-Stack E-Commerce Platform}{Personal Project}{Spokane, WA}{Jan 2026 - Present}
\begin{bullets}
  \item Architected a production-ready full-stack e-commerce platform with Next.js 14, TypeScript, and PostgreSQL (Prisma ORM)
  \item Containerized with Docker multi-stage builds and deployed on Railway with automated CI/CD via GitHub Actions
  \item Integrated Cloudflare R2 (S3-compatible) for storage and built RESTful API layer handling authentication, cart management, and order lifecycle
  \item Orchestrated multi-agent development with OpenCode and opencode-ensemble, leveraging GitHub Copilot across agents for accelerated delivery
  \item Advanced agent/worktree isolation patterns for secure parallel software engineering team orchestration
\end{bullets}
\textit{Key Skills:} Next.js, TypeScript, PostgreSQL, Prisma ORM, Docker, CI/CD, Cloudflare R2, NextAuth.js, OpenCode, GitHub Copilot, Agent Orchestration\par
...
\end{bullets}
\textit{Key Skills:} Python, vLLM, SGLang, Multi-Agent Systems, Computer Vision, Robotics
...
\end{bullets}
\textit{Key Skills:} Python, Raspberry Pi, ArduPilot, PixHawk, Computer Vision, IoT
